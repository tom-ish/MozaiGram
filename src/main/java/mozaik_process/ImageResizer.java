...
public class ImageResizer {
	...
	public static BufferedImage resizeValidDimensions(BufferedImage originalImage, int type, int imgWidth, int imgHeight) {
		int finalWidth = Math.floorDiv(imgWidth, MozaikGenerator.GRAIN) * MozaikGenerator.GRAIN;
		int finalHeight = Math.floorDiv(imgHeight, MozaikGenerator.GRAIN) * MozaikGenerator.GRAIN;
		System.out.println("imgWidth : " + imgWidth + ", imgWidth/GRAIN : " + Math.floorDiv(imgWidth, MozaikGenerator.GRAIN) + ", GRAIN : " + MozaikGenerator.GRAIN);
		System.out.println("imgHeight : " + imgHeight+ ", imgHeight/GRAIN : " + Math.floorDiv(imgHeight, MozaikGenerator.GRAIN) + ", GRAIN : " + MozaikGenerator.GRAIN);
